CREATE TABLE Users(SSN INT PRIMARY KEY NOT NULL, UserType varchar(1000), Password varchar(1000), Address char(60), Phoneno BIGINT, Fname char(20), Mname char(20), Lname char(60), Username char(30));
...
INSERT INTO Staff VALUES(132455,205730332, 'Technician', 'AIRM');
INSERT INTO Staff VALUES(132456,205730332, 'Admins', 'AIRM');
INSERT INTO Staff VALUES(132457,205730332, 'Traffic_Controller', 'AIRM');
...
CREATE TABLE Airport(Airport_id INT PRIMARY KEY NOT NULL, Type varchar(1000) , Address varchar(1000) , Airport_Name varchar(1000) );
INSERT INTO Airport VALUES(10,'Domestic T-1','Tanbar QLD 4481, Australia','Arrabury Airport');
INSERT INTO Airport VALUES(11,'International T-2 ','Abu Dhabi - United Arab Emirates','Al Ain International Airport');
INSERT INTO Airport VALUES(12,'Domestic T-1','Tanbar QLD 4481, Australia','Arrabury Airport');
CREATE TABLE Traffic_Controller(TC_id INT PRIMARY KEY NOT NULL, TC_Union_id INT, TC_Airport_id INT, Address varchar(1000), Phone_no INT, Salary INT, FOREIGN KEY (TC_Union_id) REFERENCES Staff(Mem_Union_number), FOREIGN KEY (TC_Airport_id) REFERENCES Airport(Airport_id));
INSERT INTO Traffic_Controller VALUES(1, 132455, 10, 'Arrabury Airport', 979044, 1000);
INSERT INTO Traffic_Controller VALUES(2, 132456, 11, 'Al Ain International Airport', 979041, 1000);
INSERT INTO Traffic_Controller VALUES(3, 132457, 12, 'Arrabury Airport', 979042, 1000);
...
INSERT INTO Communicate VALUES(3216, 3, 5);
CREATE TABLE FAA(Max_Score INT, FAA_date date, Score INT, FAA_Name varchar(100), No_of_Hours INT, Test_Number INT UNIQUE NOT NULL, FAA_Flight_id INT, FOREIGN KEY (FAA_Flight_id) REFERENCES Flight);
INSERT INTO FAA VALUES(71,'10/14/2018',67,'Alonzo Culpepper',10,123,3214);
INSERT INTO FAA VALUES(82,'10/22/22',81,'Aman Barry Crouch',12,14,3215);
INSERT INTO FAA VALUES(96,'12/11/69',69,'Hailey Johnna Wilson',13,129,3216);
CREATE TABLE Staff_Member(Mem_Union_number INT PRIMARY KEY NOT NULL, Union_name varchar(1000));
INSERT INTO Staff_Member VALUES(132455, 'AIRM');
INSERT INTO Staff_Member VALUES(10, 'AIRM');
...
CREATE TABLE Flight_weight_info(Company_name char(100) PRIMARY KEY NOT NULL, weight INT);
INSERT INTO Flight_weight_info VALUES('United Airlines', 1000);
CREATE TABLE Flight_capacity_info(Flight_id INT PRIMARY KEY NOT NULL, Company_name char(100), Capacity INT, FOREIGN KEY (Company_name) REFERENCES Flight_weight_info(Company_name));
INSERT INTO Flight_capacity_info VALUES(124,'United Airlines',186);
...
INSERT INTO Technician_Address VALUES(123456, 132455, 'Dallas Fort Worth', 8495533);
